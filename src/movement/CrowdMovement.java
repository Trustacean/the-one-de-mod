...
public class CrowdMovement extends MovementModel {
    ...
    private static final int GATHERING_AREA = 3;
    private int area;
    ...
    protected int chooseArea() {
        ...
        // home to gathering 0.8, home to elsewhere 0.2
        // elsewhere to home 0.9, elsewhere to elsewhere 0.1
        if (area == homeArea) {
            if (probability <= 0.2) {
